...
<%
		String name = "지역별 문화관광해설사 배치 현황" + ".xlsx";
        ...
        cell.setCellValue(String.valueOf("문화관광해설사 배치현황"));
        ...
        cell.setCellStyle(st);
        cell=row.createCell(1);
        cell.setCellValue(String.valueOf("해설사 1인당 월평균 배치일수"));
        cell.setCellStyle(st);
        cell=row.createCell(2);
        cell.setCellValue(String.valueOf("해설사 1인당 일일평균 활동시간"));
        cell.setCellStyle(st);
        cell=row.createCell(3);
        cell.setCellValue(String.valueOf("해설사 1인당 월 평균 활동시간"));
        cell.setCellStyle(st);
        cell=row.createCell(4);
        cell.setCellValue(String.valueOf("해설사 일일 최소활동시간"));
        cell.setCellStyle(st);
        cell=row.createCell(5);
        cell.setCellValue(String.valueOf("해설사 일일 최대활동시간"));
        cell.setCellStyle(st);
%>
