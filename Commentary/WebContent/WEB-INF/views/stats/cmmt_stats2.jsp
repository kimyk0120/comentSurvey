...
<input type="hidden" id="go_prt" name="go_prt" />
		...
		<div class="contents">
			...
			<div class="set-period">
				...
				<span class="btn-term3 on mr7"><a href="javascript:go_term('2')" class="btn-qtr2" title="분기 단위 선택"><span class="text-hidden">분기 단위 선택</span></a></span>
						...
						<table class="talbe-list2 dark">
							...
							<tbody>
								...
								<tr>
									...
									<th style="border-right:1px solid #fff;border-top:1px solid #fff">201</th>
									<th style="border-top:1px solid #fff">144</th>
								</tr>
							</tbody>
						</table>
					</div>
						...
						<table class="talbe-list2 dark">
							...
							<tbody>
								...
								<tr>
									<th>70대 이상</th>
									<td style="border-bottom:1px solid #fff">5</td>
									<td style="border-bottom:1px solid #fff">2</td>
								</tr>
								<tr>
									<th style="background:#d4daf3;border-right:1px solid #fff;border-top:1px solid #fff">총 계</th>
									<th style="border-right:1px solid #fff;border-top:1px solid #fff">80</th>
									<th style="border-top:1px solid #fff">42</th>
								</tr>
							</tbody>
						</table>
					</div>
