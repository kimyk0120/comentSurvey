...
<script type="text/javascript">
	...
	function go_srch() {
		...
		if( $('#srch_str_ym').val() > $('#srch_end_ym').val()  ){
			...
			document.mainform.action = "cmmt_work_stats.do";
	...
	function excel_down() {
		...
		if( $('#srch_str_ym').val() > $('#srch_end_ym').val()  ){
			...
			document.mainform.target = "_self";
			document.mainform.action = "stats_work_excel_down.do";
			document.mainform.submit();
		}
	}
		...
		<div class="contents">
			...
			<div class="col2 clearfix" style="margin-top:20px">
				<div class="shadow-box float-left" style="width:98%">
					...
					<div class="view-content" style="overflow: auto;height: 600px; width: 100%;">
						<table class="talbe-list2 dark">
							<colgroup>
								<col style="width:20%" />
								<col style="width:20%" />
