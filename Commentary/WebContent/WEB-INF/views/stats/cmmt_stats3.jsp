...
<input type="hidden" id="go_prt" name="go_prt" />
		...
		<div class="contents">
			...
			<div class="set-period">
				...
				<span class="btn-term3 on mr7"><a href="javascript:go_term('3')" class="btn-half2" title="반기 단위 선택"><span class="text-hidden">반기 단위 선택</span></a></span><!-- 선택된 보기 설정에 믈래스 on 삽입-->
					...
					<div class="view-content">
						<table class="talbe-list2 dark">
							...
							<tbody>
								...
								<tr>
									<th>70대 이상</th>
									<td style="border-bottom:1px solid #fff">8</td>
									<td style="border-bottom:1px solid #fff">4</td>
								</tr>
								<tr>
									<th style="background:#d4daf3;border-right:1px solid #fff;border-top:1px solid #fff">총 계</th>
									<th style="border-right:1px solid #fff;border-top:1px solid #fff">165</th>
									<th style="border-top:1px solid #fff">134</th>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class="view-content">
						<table class="talbe-list2 dark">
							...
							<tbody>
								...
								<tr>
									<th>70대 이상</th>
									<td style="border-bottom:1px solid #fff">12</td>
									<td style="border-bottom:1px solid #fff">5</td>
								</tr>
								<tr>
									<th style="background:#d4daf3;border-right:1px solid #fff;border-top:1px solid #fff">총 계</th>
									<th style="border-right:1px solid #fff;border-top:1px solid #fff">79</th>
									<th style="border-top:1px solid #fff">34</th>
								</tr>
							</tbody>
						</table>
					</div>
