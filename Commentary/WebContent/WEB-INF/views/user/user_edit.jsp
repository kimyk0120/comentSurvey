		...
		<div class="contents">
			...
			<table class="talbe-view">
				...
				<tbody>
					<tr>
						<th>성명</th>
						<td><input type="text" id="name" name="name" value="${info.name }" style="width:120px" /></td>
					</tr>
					<tr>
						<th>비밀번호</th>
						<td><input type="password" id="pw" name="pw" style="width:120px" maxlength="20"/></td>
					</tr>
					<tr>
						<th>비밀번호재입력</th>
						<td><input type="password" id="re_pw" name="re_pw" style="width:120px" maxlength="20"/></td>
					</tr>
					<tr>
						<th>연락처</th>
						<td>
