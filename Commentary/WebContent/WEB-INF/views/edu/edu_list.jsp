...
<script type="text/javascript">
	...
	function go_page(no) {
		...
		document.mainform.action = "edu_list.do";
...
<input type="hidden" id="page" name="page" value="edu_list.do"/>
		...
		<div class="contents">
			...
			<div class="search-block">
				...
				<div class="search-row">
					...
					<input type="text" id="srch_teacher" name="srch_teacher" placeholder="강사명 검색" value="${srch.srch_teacher}" class="readonly" style="margin-left:20px" onKeyDown="javascript:checkEnterKey()"/>
				</div><!-- // search-row -->
				<div class="btn-block">
			...
			<table class="talbe-list">
				...
				<tbody>
					...
					<tr onclick="javascript:edu_info('${c.edu_proc_seq}')">
						<td>${c.row_num}</td>
						<td>${c.lecture_nm}</td>
						...
						<td><a href="javascript:attd_stdt('${c.edu_proc_seq }')"><img src="image/btn_attend.gif" alt="출석" /></a></td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
