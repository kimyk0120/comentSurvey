...
<script type="text/javascript">
	...
	function edu_stdt_save() {
		...
		document.mainform.action = "stdt_save.do?top="+<%=request.getParameter("top") %>+"&left="+<%=request.getParameter("left") %>;
	...
	<div id="container">
		...
		<div class="contents">
			...
			<div class="contents-top">
				...
				<h3 class="mb0">${info.student_name} 수강생</h3>
			</div>
