...
<script type="text/javascript">
	...
	function go_page(no) {
		...
		document.mainform.action = "edu_attd_list.do";
...
<input type="hidden" id="page" name="page"  value="edu_attd_list.do" />
			...
			<table class="talbe-list">
				...
				<tbody>
					...
					<tr onclick="javascript:stdt_list('${c.edu_proc_seq}')">
						...
						<td><fmt:formatNumber value="${c.exam_fee}" pattern="#,###"/>원</td>
						<td>${c.stdt_cnt}</td>
