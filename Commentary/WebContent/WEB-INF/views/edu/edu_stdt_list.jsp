...
<script type="text/javascript">
	...
	function go_page(no) {
		...
		document.mainform.action = "edu_stdt_list.do";
...
<input type="hidden" id="page" name="page"  value="edu_stdt_list.do" />
			...
			<table class="talbe-list">
				...
				<tbody>
					...
					<tr onclick="javascript:stdt_list('${c.edu_proc_seq}')">
						...
						<td>${c.stdt_cnt}</td>
						<td><a href="javascript:add_stdt('${c.edu_proc_seq }')"><img src="image/btn_new_student.png" alt="등록" /></a></td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
