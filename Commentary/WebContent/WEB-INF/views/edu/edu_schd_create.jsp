		...
		if ( confirm("저장 하시겠습니까?") ) {
			...
			$.ajax({ 
				   ...
				   success: function(msg){
					   ...
					   opener.location.href="edu_schd_info.do?edu_proc_seq="+${vo.edu_proc_seq };
...
<input type="hidden" id="edu_proc_seq" name="edu_proc_seq" value="${vo.edu_proc_seq }"/>
		...
		<div class="layer-content">
			...
			<div class="row clearfix">
				<dl class="date">
					...
					<dd>
						<span class="set-date">
							<input type="text" id="edu_date" name="edu_date" style="width:80px;" />
				...
				<dl class="subject" style="width:200px">
					...
					<dd style="height:200px">
						<textarea id="subject" name="subject" style="width:95%;height:95%"></textarea>
					</dd>
				</dl>
				<dl class="detail" style="width:300px">
					<dt>세부내용</dt>
					<dd style="height:200px">
						<textarea id="sub_cntn" name="sub_cntn" style="width:95%;height:95%"></textarea>
					</dd>
				</dl>
			</div>
