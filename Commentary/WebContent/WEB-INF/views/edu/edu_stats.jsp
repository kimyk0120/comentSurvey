...
<script type="text/javascript">
	...
	function src_stats() {
		...
		if(s_yy == null || s_yy == "") {
			...
			document.mainform.action = "edu_stats.do";
			document.mainform.submit();
		}
	}
	...
	function excelDown() {
		...
		if( confirm("다운로드 하시겠습니까?") ) {
			mainform.srch_yymm.value=s_yy+"-"+s_mm;	
			document.mainform.action = "excel_down.do";
			document.mainform.submit();
	     } 
	}
...
<input type="hidden" id="left" name="left"  value="<%=request.getParameter("left") %>"/>
		...
		<div class="contents">
			...
			<div class="contents-top">
				<h2>통계</h2>
				<div class="btn-block">
					<a href="javascript:excelDown()"><span>액셀다운</span></a>
				</div>
			</div>
			...
			<div class="search-block">
				<div class="search-row">
					...
					<select class="formSelect" id="srch_prt" name="srch_prt" style="width:100px;" >
						<option value="1">교육기관</option>
						<option value="2">강사</option>
					</select>
					<span class="txt-label" style="min-width:0px;margin-left:20px">기준년월</span>
			...
			<table class="talbe-list">
				<colgroup>
					<col style="width:14%;border-right:1px solid #dedede" />
					<col style="width:14%;border-right:1px solid #dedede"  />
					<col style="width:4%" />
					<col style="width:4%" />
					<col style="width:4%;border-right:1px solid #dedede" />
					<col style="width:4%" />
					<col style="width:4%" />
					<col style="width:4%;border-right:1px solid #dedede" />
					<col style="width:4%" />
				...
				<thead>
					...
					<tr style="height:50px;">
						<th style="border-right:1px solid #dedede;border-top:1px solid #dedede">횟수</th>
						<th style="padding:0px;border-right:1px solid #dedede;border-top:1px solid #dedede">수강생</th>
						<th style="padding:0px;border-right:1px solid #dedede;border-top:1px solid #dedede">검정률</th>
						<th style="border-right:1px solid #dedede;border-top:1px solid #dedede">횟수</th>
						<th style="padding:0px;border-right:1px solid #dedede;border-top:1px solid #dedede">수강생</th>
						<th style="padding:0px;border-right:1px solid #dedede;border-top:1px solid #dedede">검정률</th>
						<th style="border-right:1px solid #dedede;border-top:1px solid #dedede">횟수</th>
						...
						<th style="border-right:1px solid #dedede;border-top:1px solid #dedede">횟수</th>
						<th style="padding:0px;border-right:1px solid #dedede;border-top:1px solid #dedede">수강생</th>
						<th style="padding:0px;border-top:1px solid #dedede">검정률</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						...
						<td style="padding:0px;border-right:1px solid #dedede">${c.cnt1}</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.st_cnt1}</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.ex_cnt1}%</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.cnt2}</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.st_cnt2}</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.ex_cnt2}%</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.cnt3}</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.st_cnt3}</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.ex_cnt3}%</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.cnt4}</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.st_cnt4}</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.ex_cnt4}%</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.cnt5}</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.st_cnt5}</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.ex_cnt5}%</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.cnt6}</td>
						<td style="padding:0px;border-right:1px solid #dedede">${c.st_cnt6}</td>
