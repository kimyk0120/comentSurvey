...
<script type="text/javascript">
	...
	function cust_save() {
		...
		document.mainform.action = "cust_save.do";
			...
			<table class="talbe-view">
				...
				<tbody>
					<tr>
						...
						<td colspan="3">
							<c:choose>
								<c:when test="${srch.cust_no eq '' || srch.cust_no eq null}">
					...
					<tr>
						<th>가족수</th>
						<td><input type="text" id="fmly_cnt" name="fmly_cnt" value="${info.fmly_cnt }" style="width:60px" /> 명</td>
						<th>평수</th>
						<td><input type="text" id="house_space" name="house_space" value="${info.house_space }" style="width:60px" /> 평</td>
					</tr>
					<tr>
						<th>거주형태</th>
						<td>
						...
						<th>거주년수</th>
						<td><input type="text" id="live_prd" name="live_prd" value="${info.live_prd}" style="width:60px" /> 년</td>
					</tr>
					<tr>
						<th>비고</th>
						<td colspan="3"><textarea id="bigo" name="bigo" style="height:120px;width:95%;padding:5px;margin:2px">${info.bigo}</textarea></td>
					</tr>
				</tbody>
			</table>
