			...
			<table class="talbe-view">
				...
				<tbody>
					<tr>
						...
						<td>
							<span class="set-date">
								<input type="text" id="odr_dt" name="odr_dt" style="width:80px;" />
					...
					<tr>
						<th>출고단가</th>
						<td>
							<input type="text" id="unit_price" name="unit_price" style="width:120px" onkeyup="javascript:cmaComma(this)" /> <span>\</span>
						</td>
					</tr>
					<tr>
						<th>수량</th>
						<td>
							<input type="text" id="qty" name="qty" style="width:100px" onkeyup="javascript:get_amt(this);"/>
						</td>
					</tr>
					<tr>
						<th>금액</th>
						<td>
							<input type="text" id="amt" name="amt" style="width:120px" readonly="readonly" />  <span>\</span>
						</td>
					</tr>
					<tr>
						<th>지급액</th>
						<td>
							<input type="text" id="pay" name="pay" style="width:120px" onkeyup="javascript:comma(this);"/>  <span>\</span>
						</td>
					</tr>
					<tr>
						<th>지급일</th>
						<td>
							<span class="set-date">
								<input type="text" id="pay_dt" name="pay_dt" style="width:80px;" />
								<span class="btn-calendar"><img src="image/btn_calendar_input.gif" alt="시작일 선택" /></span><!-- 달력 선택 버튼 -->
							</span>
						</td>
					</tr>
