...
<script type="text/javascript">
	...
	function wrhs_create() {
		document.mainform.action = "prod_wrhs_create.do";
		document.mainform.submit();
	}
	...
	function prod_wrhs_info(seq) {
		mainform.w_no.value = seq;
		document.mainform.action = "prod_wrhs_info.do";
		document.mainform.submit();
	}
...
<input type="hidden" id="left" name="left"  value="<%=request.getParameter("left") %>"/>
		...
		<div class="contents">
			...
			<div class="contents-top">
				<h2>입고</h2>
				<div class="btn-block">
					<a href="javascript:wrhs_create()"><span>입고신청</span></a>
				</div>
			</div>

			<div class="search-block">
				<div class="search-row">
					<input type="text" id="srch_name" name="srch_name" placeholder="거래처명 검색" value="${srch.srch_name}" class="readonly" />
					<input type="text" id="srch_prod" name="srch_prod" placeholder="폼목명 검색" value="${srch.srch_prod}" class="readonly" />
					<span class="txt-label">주문기간</span>
					<span class="set-date">
				...
				<div class="btn-block">
					<a href="javascript:srch_wrhs()"><span class="btn-search">조회하기</span></a>
				</div><!-- // btn-block -->
			</div><!-- // search-block -->
			...
			<table class="talbe-list">
				...
				<thead>
					<tr>
						...
						<th style="padding:0px 5px">지급일</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						...
						<td style="padding:0px 5px"><a href="javascript:prod_wrhs_info('${c.wrhs_no}')" >${c.odr_dt}</a></td>
						<td style="padding:0px 5px"><a href="javascript:prod_wrhs_info('${c.wrhs_no}')" >${c.prod_name}</a></td>
						<td style="padding:0px 5px"><a href="javascript:prod_wrhs_info('${c.wrhs_no}')" >${c.pchs_cust_name}</a></td>
						...
						<td style="padding:0px 5px">${c.pay_dt}</td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
