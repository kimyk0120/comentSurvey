...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		var p = "<c:out value="${info.main_prod_code}"/>";
		if(p != null && p != '') {
			$("#main_prod_code").val(p).change(); 
		}
		...
		<div class="contents">
			...
			<table class="talbe-view">
				...
				<tbody>
					<tr>
						<th>거래처명</th>
						<td><input type="text" id="pchs_cust_name" name="pchs_cust_name" value="${info.pchs_cust_name} "/></td>
					</tr>
					<tr>
						<th>담당자</th>
						<td><input type="text" id="pchs_chrg_name" name="pchs_chrg_name" value="${info.pchs_chrg_name }" /></td>
					</tr>
					<tr>
						<th>연락처</th>
						<td>
							...
							<input type="text" id="ph2" name="ph2" style="width:40px" maxlength="4" value="${info.ph2 }"/>
							<span class="txt-symbol">-</span>
							<input type="text" id="ph3" name="ph3" style="width:40px" maxlength="4" value="${info.ph3 }"/>
						</td>
					</tr>
					<tr>
						<th>주요품목</th>
