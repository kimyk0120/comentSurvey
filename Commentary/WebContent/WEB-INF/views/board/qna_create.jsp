...
<script type="text/javascript">
	...
	function qna_save() {
		...
		if(s_sido == "") {
			...
			if(confirm("저장하시겠습니까?")) {
				document.mainform2.action = "qna_save.do?top="+<%=request.getParameter("top") %>+"&left="+<%=request.getParameter("left") %>;
	...
	function qna_list() {
		document.mainform.action = "qna_list.do?top="+<%=request.getParameter("top") %>+"&left="+<%=request.getParameter("left") %>;
...
<div id="wrapper">
	...
	<input type="hidden" id="ori_q_no" name="ori_q_no" value="${ori_q_no }"/>
		...
		<div class="contents">
			...
			<div class="shadow-box" style="padding-top:20px">
					...
					<tbody>
						...
						<tr>
							...
							<td class="padding-cell">
								<!-- <textarea id="cntn" name="cntn" style="width:95%; height:500px" ></textarea> -->
				...
				<div class="btn-block text-center mt20">
					<a href="javascript:qna_save()" class="btn-blue"><span>내역 등록</span></a>
					<a href="javascript:qna_list()" class="btn-orange"><span>취소</span></a>
				</div>
			</div>
